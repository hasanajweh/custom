...
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <form method="POST" action="{{ route('school.admin.users.update', ['school' => $school->slug, 'user' => $user->id]) }}" class="p-6 space-y-6">
            @csrf
            @method('PATCH')
            ...
            <div class="flex items-center justify-end space-x-4 pt-4 border-t border-gray-200">
                <a href="{{ route('school.admin.users.index', ['school' => $school->slug]) }}" class="px-6 py-3 text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg font-semibold transition-colors">
