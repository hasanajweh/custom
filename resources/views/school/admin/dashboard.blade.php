            ...
            <div class="px-8 py-6 border-b border-gray-100">
                <div class="flex items-center justify-between flex-wrap gap-4">
                    ...
                    <div class="flex items-center gap-3 no-print">
                        ...
                        <a href="{{ safe_tenant_route('school.admin.file-browser.index', $school) }}?role=teacher"
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-8 py-6 no-print">
                                <div class="flex items-center justify-center space-x-2">
                                    ...
                                    @if($canPreview)
                                        <button onclick="printFile('{{ safe_tenant_route('school.admin.file-browser.preview', $school, ['file' => $file->id]) }}', '{{ $file->title }}', '{{ $file->user->name ?? __('messages.users.unknown') }}', '{{ $file->created_at->format('M d, Y') }}')"
            ...
            <div class="px-8 py-6 border-b border-gray-100">
                <div class="flex items-center justify-between flex-wrap gap-4">
                    ...
                    <div class="flex items-center gap-3 no-print">
                        ...
                        <a href="{{ safe_tenant_route('school.admin.file-browser.index', $school) }}?role=supervisor"
