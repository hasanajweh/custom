<?php $__env->startSection('page-title', 'School Users'); ?>
    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-2 text-gray-400">Manage users for <span class="text-indigo-400"><?php echo e($school->name); ?></span></p>
            </div>
            ...
            <div class="glass rounded-lg p-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-purple-400"><?php echo e($users->where('role', 'admin')->count()); ?></p>
                    </div>
            ...
            <div class="glass rounded-lg p-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-blue-400"><?php echo e($users->where('role', 'teacher')->count()); ?></p>
                    </div>
            ...
            <div class="glass rounded-lg p-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-green-400"><?php echo e($users->where('role', 'supervisor')->count()); ?></p>
                    </div>
                    ...
                    <tr class="hover:bg-gray-800 transition-colors">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="h-10 w-10 flex-shrink-0 rounded-full <?php echo e(getAvatarColor($user->name)); ?> flex items-center justify-center font-semibold text-white">
                                    <?php echo e(getInitials($user->name)); ?>

                                </div>
                                <div class="ml-4">
                                    <div class="text-sm font-medium text-white"><?php echo e($user->name); ?></div>
                                    <?php if($user->subject): ?>
                                        <div class="text-xs text-gray-400"><?php echo e($user->subject); ?></div>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e(getRoleBadgeClass($user->role)); ?>">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                            <div class="flex items-center space-x-2">
                                <a href="<?php echo e(route('superadmin.users.edit', ['school' => $school, 'user' => $user])); ?>"
                                   class="text-indigo-400 hover:text-indigo-300 transition">
                                    Edit
                                </a>
                                <?php if($user->id !== auth()->id()): ?>
                                    <form method="POST" action="<?php echo e(route('superadmin.users.destroy', ['school' => $school, 'user' => $user])); ?>" class="inline">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.superadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eXtreme\Documents\custom\resources\views\superadmin\users\index.blade.php ENDPATH**/ ?>