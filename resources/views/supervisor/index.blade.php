        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <div class="group bg-gradient-to-br from-gray-50 to-white rounded-xl border border-gray-200 hover:border-indigo-300 hover:shadow-lg transition-all duration-300 overflow-hidden">
                            ...
                            <div class="p-4 space-y-3">
                                ...
                                <div class="flex items-center justify-between pt-3 border-t border-gray-100">
                                    <a href="{{ safe_tenant_route('school.admin.supervisors.files', $school, ['supervisor' => $supervisor->id]) }}"
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <a href="{{ safe_tenant_route('school.admin.users.edit', $school, ['user' => $supervisor->id]) }}"
            ...
            @else
                ...
                <div class="py-16 text-center">
                    ...
                    <a href="{{ safe_tenant_route('school.admin.users.create', $school) }}?role=supervisor"
