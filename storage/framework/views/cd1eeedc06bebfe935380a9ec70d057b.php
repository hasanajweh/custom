  <!DOCTYPE html>
<html lang="<?php echo e(app()->getLocale()); ?>" dir="<?php echo e(app()->getLocale() === 'ar' ? 'rtl' : 'ltr'); ?>" class="h-full <?php echo e(app()->getLocale() === 'ar' ? 'rtl' : 'ltr'); ?>">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">

    <title><?php echo e(config('app.name', 'Scholder')); ?> - Super Admin</title>
                ...
                <div class="relative z-10 flex h-16 flex-shrink-0 bg-gray-800 shadow-lg border-b border-gray-700">
                    ...
                    <div class="flex flex-1 justify-between px-4 sm:px-6 lg:px-8">
                        <div class="flex flex-1 items-center">
                            <h1 class="text-xl font-semibold text-white"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></h1>
                        </div>
                        <div class="ml-4 flex items-center space-x-4 <?php echo e(app()->getLocale() === 'ar' ? 'space-x-reverse' : ''); ?>">
                            <form id="lang-switcher" method="POST">
                                <?php echo csrf_field(); ?>
                                <button type="button" onclick="switchLocale('<?php echo e(app()->getLocale() === 'ar' ? 'en' : 'ar'); ?>')" class="inline-flex items-center gap-2 text-sm font-medium text-gray-200 hover:text-white">
...
<?php /**PATH C:\Users\eXtreme\Documents\custom\resources\views\layouts\superadmin.blade.php ENDPATH**/ ?>