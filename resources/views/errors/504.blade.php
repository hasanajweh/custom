...
<head>
    ...
    <title>{{ __('messages.errors.504.title', [], 'Gateway Timeout') }} - {{ __('messages.app.name') }}</title>
...
<div class="text-center max-w-2xl mx-auto">
    ...
    <h1 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4">{{ __('messages.errors.504.heading', [], 'Gateway Timeout') }}</h1>
    <p class="text-lg text-gray-600 mb-8 max-w-md mx-auto">{{ __('messages.errors.504.message', [], 'The server did not receive a timely response from an upstream server.') }}</p>
