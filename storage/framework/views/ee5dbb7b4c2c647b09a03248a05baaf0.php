...
<head>
    ...
    <title><?php echo e(__('messages.errors.500.title')); ?> - <?php echo e(__('messages.app.name')); ?></title>
...
<div class="text-center max-w-2xl mx-auto">
    ...
    <h1 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4"><?php echo e(__('messages.errors.500.heading')); ?></h1>
    <p class="text-lg text-gray-600 mb-8 max-w-md mx-auto"><?php echo e(__('messages.errors.500.message')); ?></p>
    <div class="flex flex-col sm:flex-row gap-4 justify-center">
        <a href="javascript:location.reload()" class="inline-flex items-center px-6 py-3 bg-white text-gray-700 font-semibold rounded-lg shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200 border border-gray-200">
            ...
            <?php echo e(__('messages.errors.500.action')); ?>
...
<?php /**PATH C:\Users\eXtreme\Documents\custom\resources\views\errors\500.blade.php ENDPATH**/ ?>