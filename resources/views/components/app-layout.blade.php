            ...
            <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('profile.edit', ['school' => Auth::user()->school->slug])">
                            ...
                            <form method="POST" action="{{ route('logout', ['school' => Auth::user()->school->slug]) }}">
                                @csrf
                                <x-dropdown-link :href="route('logout', ['school' => Auth::user()->school->slug])" onclick="event.preventDefault(); this.closest('form').submit();">
                                    <svg class="mr-2 h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
