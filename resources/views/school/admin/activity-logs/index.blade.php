            ...
            <div class="space-y-6">
                <div class="rounded-3xl border border-slate-100 bg-white/80 p-6 shadow-lg backdrop-blur">
                    <div class="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                        ...
                        <form method="GET" action="{{ safe_tenant_route('school.admin.activity-logs.index', $school) }}" class="w-full lg:w-auto">
                            ...
                            <div class="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center">
                                ...
                                <a href="{{ safe_tenant_route('school.admin.activity-logs.index', $school) }}" class="inline-flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-slate-600 shadow-sm transition hover:bg-slate-50">
