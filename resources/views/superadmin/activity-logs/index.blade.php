    ...
    <div class="space-y-8">
        ...
        <div class="relative overflow-hidden rounded-2xl p-8 glass-morphism animate-fade-in-up">
            ...
            <div class="relative flex items-center justify-between">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('superadmin.activity-logs.export', request()->all()) }}"
        ...
        <div class="gradient-border animate-fade-in-up" style="animation-delay: 0.5s;">
            <div class="glass-morphism rounded-2xl p-8">
                ...
                <form method="GET" action="{{ route('superadmin.activity-logs.index') }}" class="grid grid-cols-1 md:grid-cols-6 gap-6">
                    ...
                    <div class="flex items-end space-x-3">
                        ...
                        <a href="{{ route('superadmin.activity-logs.index') }}" class="px-6 py-3 bg-gray-700/50 hover:bg-gray-600/50 text-white font-semibold rounded-xl transition-all duration-300 flex items-center space-x-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            @if($activeUser['user'])
                                <div class="user-badge group bg-gradient-to-br from-gray-800/80 to-gray-900/80 rounded-xl p-5 border border-gray-700/50 hover:border-indigo-500/50">
                                    <div class="flex flex-col items-center text-center space-y-3">
                                        ...
                                        <div>
                                            <p class="text-sm font-bold text-white truncate max-w-full">{{ $activeUser['user']->name }}</p>
                                            <p class="text-xs text-gray-400 mt-1">{{ $activeUser['user']->role ?? 'User' }}</p>
                                            <div class="mt-2 inline-flex items-center px-3 py-1 bg-indigo-900/50 rounded-full">
                                                ...
                                                <span class="text-xs font-bold text-indigo-400">{{ $activeUser['activity_count'] }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start justify-between">
                                    <div class="flex-1 space-y-3">
                                        ...
                                        <div class="flex flex-wrap items-center gap-2">
                                            ...
                                            @if(!empty($activity->properties['school_name']))
                                                <div class="flex items-center space-x-1 bg-indigo-900/30 px-3 py-1 rounded-lg">
                                                    ...
                                                    <span class="text-xs font-semibold text-indigo-300">{{ $activity->properties['school_name'] }}</span>
                                                </div>
                                            @endif
                                        ...
                                        <!-- Description -->
                                        <p class="text-sm text-gray-200 leading-relaxed">{{ $activity->description }}</p>
                                        ...
                                        <div class="flex flex-wrap items-center gap-4 text-xs text-gray-400">
                                            <span class="flex items-center space-x-1">
                                                ...
                                                <span class="font-medium">{{ $activity->created_at->format('M d, Y • H:i:s') }}</span>
                                            ...
                                            @if(!empty($activity->properties['ip_address']))
                                                <span class="flex items-center space-x-1">
                                                    ...
                                                    <span class="font-mono">{{ $activity->properties['ip_address'] }}</span>
                                                </span>
                                            @endif
                                            ...
                                            @if(!empty($activity->properties['user_agent']))
                                                <span class="flex items-center space-x-1">
                                                    ...
                                                    <span class="truncate max-w-xs" title="{{ $activity->properties['user_agent'] }}">
                                                        {{ Str::limit($activity->properties['user_agent'], 40) }}
                                                    </span>
                                                </span>
                                            @endif
                                        </div>
                                    ...
                                    <!-- View Action -->
                                    <div class="ml-4">
                                        <a href="{{ route('superadmin.activity-logs.show', $activity) }}"
