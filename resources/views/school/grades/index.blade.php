...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
    ...
    <div class="lg:col-span-1">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-visible">
            ...
            <div class="p-6">
                <form method="POST" action="{{ route('school.admin.grades.store', ['school' => $school->slug]) }}" class="space-y-6">
                    @csrf
                    <div>
                                ...
                                <div class="relative z-50">
                                    ...
                                    >
                                        ...
                                        <div class="flex justify-end space-x-2">
                                            ...
                                            <form method="POST"
                                                action="{{ route('school.admin.grades.destroy', ['school' => $school->slug, 'grade' => $grade->id]) }}">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
