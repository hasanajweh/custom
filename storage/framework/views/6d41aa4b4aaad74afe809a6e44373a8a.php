<?php $__env->startSection('title', __('messages.files.upload_resource') . ' - ' . $school->name); ?>
    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-white to-green-50 py-8 px-4">
        <div class="max-w-2xl mx-auto">
                            ...
                            <div class="flex-1">
                                <h3 class="text-3xl font-bold text-white mb-2 flex flex-col lg:flex-row lg:items-center lg:space-x-3">
                                    <span class="flex items-center">
                                        🎉 <?php echo e($successTitleEn); ?>

                                    </span>
                                    <span class="text-2xl lg:text-3xl font-bold text-white/90"><?php echo e($successTitleAr); ?></span>
                                    <span class="mt-3 lg:mt-0 inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-white/20 text-white backdrop-blur-sm">
                                        ✓ <?php echo e($statusCompletedEn); ?> | <?php echo e($statusCompletedAr); ?>

                                    </span>
                                </h3>

                                <p class="text-lg lg:text-xl text-white/95 font-medium mb-1">
                                    <?php echo e($successMessageEn); ?>

                                </p>
                                <p class="text-lg lg:text-xl text-white/90 font-medium">
                                    <?php echo e($successMessageAr); ?>
            ...
            <div class="text-center mb-10">
                ...
                <h1 class="text-4xl font-bold text-gray-900 mb-3"><?php echo e(__('messages.files.upload_resource')); ?></h1>
                <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                    
                    <?php echo e(__('messages.files.files_available_teachers')); ?>
                ...
                <?php if(isset($subjectNames) && $subjectNames): ?>
                    <div class="mt-4 inline-flex items-center px-4 py-2 bg-green-100 text-green-800 rounded-full">
                        ...
                        <span class="font-semibold"><?php echo e(trans_choice('messages.subjects.total_subjects', $subjectCount)); ?>: <?php echo e($subjectNames); ?></span>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="bg-white rounded-3xl shadow-xl overflow-hidden">
                <div class="bg-gradient-to-r from-green-600 to-teal-600 p-6 text-white">
                    <h2 class="text-2xl font-bold flex items-center">
                        ...
                        <?php echo e(__('messages.quick_upload')); ?>

                    </h2>
                    
                    <p class="mt-2 text-green-100"><?php echo e(__('messages.files.quick_simple_upload')); ?></p>
                </div>

                <form method="POST" action="<?php echo e(tenant_route('supervisor.files.store', $school)); ?>"
                    ...
                    <div>
                        <label for="title" class="flex items-center text-sm font-semibold text-gray-700 mb-3">
                            ...
                            <?php echo e(__('messages.files.resource_title')); ?> <span class="text-red-500 ml-1">*</span>
                        </label>
                        <input type="text"
                               id="title"
                               name="title"
                               ...
                               placeholder="<?php echo e(__('messages.placeholders.example_title')); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        <label class="flex items-center text-sm font-semibold text-gray-700 mb-3">
                            ...
                            <?php echo e(__('messages.files.upload_file')); ?> <span class="text-red-500 ml-1">*</span>
                        </label>
                        ...
                        <label for="file" class="block cursor-pointer group">
                            <div id="dropZone" class="relative border-3 border-dashed border-gray-300 rounded-3xl p-12 text-center transition-all duration-300 hover:border-green-400 hover:bg-gradient-to-br hover:from-green-50 hover:to-teal-50 group-hover:shadow-xl">
                                <div class="relative max-w-md mx-auto">
                                    ...
                                    <p class="text-xl font-bold text-gray-800 mb-2"><?php echo e(__('messages.files.click_to_upload')); ?></p>
                                    <p class="text-gray-600 mb-4"><?php echo e(__('messages.files.drag_drop')); ?></p>
                                    <p class="text-sm text-gray-500">
                                        <svg class="w-4 h-4 inline mr-1" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"/>
                                        </svg>
                                        
                                        <?php echo e(__('messages.files.supports_formats')); ?> (<?php echo e(__('messages.files.max_size', ['size' => '100MB'])); ?>)
                                    </p>
                                    ...
                                    <div id="fileInfo" class="hidden mt-6 bg-green-50 rounded-2xl p-4 border border-green-200 text-left">
                                        <div class="flex items-center">
                                            ...
                                            <button type="button" onclick="removeFile(event)" class="ml-4 text-red-500 hover:text-red-700 transition-colors" title="<?php echo e(__('messages.actions.remove')); ?>">
                            ...
                            <div class="ml-3">
                                ...
                                <ul class="text-sm text-blue-800 space-y-1">
                                    <li class="flex items-center">
                                        ...
                                        <?php echo e(__('messages.labels.subject')); ?>: <strong class="ml-1"><?php echo e($subjectNames ?? __('messages.files.no_subjects_assigned')); ?></strong>
                                    </li>
                                    <li class="flex items-center">
                                        <svg class="w-4 h-4 text-blue-600 mr-2" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                        ...
                                        <?php echo e(__('messages.labels.type')); ?>: <strong class="ml-1"><?php echo e(__('messages.files.supervisor_resource')); ?></strong>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="flex items-center justify-between pt-6 border-t border-gray-200">
                        ...
                        <button type="submit" id="submitBtn"
                            ...
                            <span id="submitText" class="flex items-center">
                                ...
                                <?php echo e(__('messages.files.upload_resource')); ?>
    ...
    <script>
        ...
        uploadForm.addEventListener('submit', function(e) {
            ...
            if (!fileInput.files || fileInput.files.length === 0) {
                ...
                alert(<?php echo \Illuminate\Support\Js::from(__('messages.files.select_file_prompt'))->toHtml() ?>);
                return false;
            }
...
<?php echo $__env->make('layouts.school', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eXtreme\Documents\custom\resources\views\supervisor\files\create.blade.php ENDPATH**/ ?>