...
<head>
    ...
    <meta name="description" content="Educational platform for {{ $networkName }} - Manage files, assignments, and resources">
    <meta name="keywords" content="education, {{ $networkName }}, learning, teaching, resources">
            ...
            <div class="flex items-center">
                ...
                <div class="logo-container {{ app()->getLocale() === 'ar' ? 'mr-4' : 'ml-4' }}">
                    ...
                    <div class="brand-text">
                        ...
                        <span class="school-name">{{ $networkName }}</span>
                    </div>
                </div>
            </div>
                            ...
                            <div class="space-y-2">
                                @foreach($availableContexts as $ctx)
                                    ...
                                    @if($schoolCtx && $networkCtx)
                                        <form method="POST" action="{{ route('tenant.switch-context') }}">
                                            @csrf
...
<aside id="sidebar" class="sidebar {{ app()->getLocale() === 'ar' ? 'rtl' : '' }}">
    ...
    <div class="sidebar-content">
        <nav class="space-y-1">
            ...
            @endphp
            <a href="{{ $dashboardUrl }}"
               class="sidebar-item {{ request()->routeIs('main-admin.dashboard') ? 'active' : '' }}">
