...
@section('content')
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 md:p-6">
            <form method="GET" action="{{ route('supervisor.reviews.index', $school->slug) }}" class="space-y-4">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <div class="flex items-center justify-center space-x-2">
                                    {{-- Preview Button --}}
                                    @if($canPreview)
                                        <a href="{{ route('supervisor.reviews.preview', [$school->slug, $file->id]) }}"
                                           target="_blank"
                                    ...
                                    <a href="{{ route('supervisor.reviews.download', [$school->slug, $file->id]) }}"
                                    ...
                                    {{-- Print Button --}}
                                    @if($canPreview)
                                        <button onclick="printFile('{{ route('supervisor.reviews.preview', [$school->slug, $file->id]) }}', '{{ $file->title }}', '{{ $teacherName }}', '{{ $file->created_at->format('M d, Y') }}')"
