...
<?php $__env->startSection('content'); ?>
    <div class="space-y-6">
        <!-- Welcome Section -->
        <div>
            <h1 class="text-3xl font-bold text-white">Welcome back, <?php echo e(Auth::user()->name); ?>!</h1>
            ...
            <div class="card-hover glass rounded-lg p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-3xl font-bold text-white"><?php echo e($totalSchools); ?></p>
            ...
            <div class="card-hover glass rounded-lg p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-3xl font-bold text-white"><?php echo e($activeSubscriptions); ?></p>
                        <p class="mt-1 text-sm text-green-400">
                            <span class="font-medium"><?php echo e($activeSchools); ?> active</span> schools
                        </p>
                    </div>
            ...
            <div class="card-hover glass rounded-lg p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-3xl font-bold text-white"><?php echo e($totalUsers); ?></p>
                        <p class="mt-1 text-sm text-purple-400">
                            <span class="font-medium"><?php echo e($newUsersThisMonth); ?></span> this month
                        </p>
                    </div>
            ...
            <div class="card-hover glass rounded-lg p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-3xl font-bold text-white">$<?php echo e(number_format($monthlyRevenue, 2)); ?></p>
        ...
        <div class="glass rounded-lg p-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="<?php echo e(route('superadmin.schools.index')); ?>" class="text-sm text-indigo-400 hover:text-indigo-300">
                    View all →
                </a>
            </div>
                    ...
                    <?php $__currentLoopData = $recentSchools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $school): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-gray-800 transition-colors">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div>
                                    <div class="text-sm font-medium text-white"><?php echo e($school->name); ?></div>
                                    <div class="text-sm text-gray-400"><?php echo e($school->slug); ?></div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                               <span class="inline-flex rounded-full px-2 text-xs font-semibold leading-5 bg-indigo-900 text-indigo-200">
                                   <?php echo e($school->activeSubscription?->plan?->name ?? 'No Plan'); ?>

                               </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300">
                                <?php echo e($school->users_count); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300">
                                <?php echo e($school->created_at->format('M d, Y')); ?>
...
<?php echo $__env->make('layouts.superadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eXtreme\Documents\custom\resources\views\superadmin\dashboard.blade.php ENDPATH**/ ?>