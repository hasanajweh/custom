...
<?php $__env->startSection('title', __('messages.grades.title') . ' - ' . __('messages.app.name')); ?>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-visible">
            <div class="bg-gradient-to-r from-green-50 to-emerald-50 px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-semibold text-gray-900 flex items-center">
                    ...
                    <?php echo e(__('messages.grades.add_new_grade')); ?>

                </h3>
                <p class="text-sm text-gray-600 mt-1"><?php echo e(__('messages.grades.create_grade_levels')); ?></p>
            </div>
            <div class="p-6">
                <form method="POST" action="<?php echo e(tenant_route('school.admin.grades.store', $school)); ?>" class="space-y-6">
                    <?php echo csrf_field(); ?>
                    <div>
                        <label for="name" class="block text-sm font-medium text-gray-700 mb-2">
                            <?php echo e(__('messages.grades.grade_name')); ?>

                        </label>
                        <input type="text" id="name" name="name" required
                            placeholder="<?php echo e(__('messages.grades.grade_placeholder')); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <button type="submit"
                        class="w-full bg-gradient-to-r from-emerald-600 to-green-700 text-white py-3 px-4 rounded-lg hover:from-emerald-700 hover:to-green-800 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 transition duration-200 font-medium">
                        <?php echo e(__('messages.grades.create_grade')); ?>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-visible">
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                <h3 class="text-lg font-semibold text-gray-900 flex items-center">
                    ...
                    <?php echo e(__('messages.grades.current_grades')); ?>

                </h3>
                <div class="flex items-center space-x-2">
                    <span class="bg-emerald-100 text-emerald-800 text-xs font-medium px-3 py-1 rounded-full">
                        <?php echo e(trans_choice('messages.grades.total_grades', $grades->count(), ['count' => $grades->count()])); ?>

                    </span>
                    <span class="bg-gray-100 text-gray-700 text-xs font-medium px-3 py-1 rounded-full">
                        <?php echo e(trans_choice('messages.archived.total', $archivedGrades->count(), ['count' => $archivedGrades->count()])); ?>
            ...
            <div class="p-6">
                        ...
                        <?php $__currentLoopData = $grades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200 hover:bg-gray-100 transition duration-200"
                                ...
                                <div class="flex items-center space-x-3">
                                    <div class="h-10 w-10 bg-gradient-to-br from-emerald-100 to-green-200 rounded-lg flex items-center justify-center">
                                    ...
                                    <div>
                                        <h4 class="font-medium text-gray-900"><?php echo e($grade->name); ?></h4>
                                        <p class="text-sm text-gray-500">
                                            <?php echo e(__('messages.grades.created')); ?> <?php echo e($grade->created_at->diffForHumans()); ?>
                                ...
                                <div class="relative z-50" :class="{'text-right': '<?php echo e(app()->getLocale() == 'ar'); ?>'}">
                                    ...
                                    >
                                        ...
                                        <div class="flex justify-end space-x-2">
                                            ...
                                            <form method="POST"
                                                action="<?php echo e(tenant_route('school.admin.grades.archive', [$school, $grade])); ?>">
                                                <?php echo csrf_field(); ?>
                ...
                <?php else: ?>
                    <div class="text-center py-12 text-gray-500">
                        <?php echo e(__('messages.grades.no_grades_message')); ?>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-visible">
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                <div class="flex items-center space-x-2">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900"><?php echo e(__('messages.grades.archived_grades')); ?></h3>
                </div>
                <span class="bg-gray-100 text-gray-700 text-xs font-medium px-3 py-1 rounded-full">
                    <?php echo e(trans_choice('messages.archived.total', $archivedGrades->count(), ['count' => $archivedGrades->count()])); ?>
            ...
            <div class="p-6">
                <?php if($archivedGrades->count() > 0): ?>
                    <div class="grid gap-4">
                        <?php $__currentLoopData = $archivedGrades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <h4 class="font-medium text-gray-900"><?php echo e($grade->name); ?></h4>
                                        <p class="text-sm text-gray-500">
                                            <?php echo e(__('messages.archived.archived_on', ['date' => $grade->deleted_at->diffForHumans()])); ?>

                                        </p>
                                    </div>
                                </div>
                                <form method="POST" action="<?php echo e(tenant_route('school.admin.grades.restore', [$school, $grade])); ?>">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PATCH'); ?>
...
<?php echo $__env->make('layouts.school', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eXtreme\Documents\custom\resources\views\school\admin\grades\index.blade.php ENDPATH**/ ?>