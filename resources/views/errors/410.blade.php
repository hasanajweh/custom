...
<head>
    ...
    <title>{{ __('messages.errors.410.title', [], 'Gone') }} - {{ __('messages.app.name') }}</title>
...
<div class="text-center max-w-2xl mx-auto">
    ...
    <h1 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4">{{ __('messages.errors.410.heading', [], 'Resource Gone') }}</h1>
    <p class="text-lg text-gray-600 mb-8 max-w-md mx-auto">{{ __('messages.errors.410.message', [], 'The resource you are looking for is no longer available.') }}</p>
