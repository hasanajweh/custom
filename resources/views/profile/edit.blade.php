        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <form method="POST" action="{{ safe_tenant_route('profile.update', $school) }}" class="p-6 space-y-6">
                        @csrf
                        @method('PATCH')
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <form method="POST" action="{{ safe_tenant_route('profile.password.update', $school) }}" class="p-6 space-y-6">
                        @csrf
                        @method('PATCH')
