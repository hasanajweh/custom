...
@extends('layouts.school', ['school' => $school])
    ...
    <div class="max-w-4xl mx-auto py-8 px-4">
        <div class="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div class="mt-8 text-center">
                <a href="{{ tenant_route('teacher.files.index', $school) }}" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl font-bold hover:shadow-lg transition-all">
