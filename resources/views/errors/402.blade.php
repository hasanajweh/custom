...
<head>
    ...
    <title>{{ __('messages.errors.402.title', [], 'Payment Required') }} - {{ __('messages.app.name') }}</title>
...
<div class="text-center max-w-2xl mx-auto">
    <div class="relative mb-8">
        <div class="text-[150px] md:text-[200px] font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-600 leading-none">402</div>
    ...
    <h1 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4">{{ __('messages.errors.402.heading', [], 'Payment Required') }}</h1>
    <p class="text-lg text-gray-600 mb-8 max-w-md mx-auto">{{ __('messages.errors.402.message', [], 'Payment is required to access this resource.') }}</p>
