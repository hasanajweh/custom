<?php $__env->startSection('page-title', 'Manage Subscriptions'); ?>
    ...
    <div class="space-y-8">
                    ...
                    <div class="revenue-badge px-6 py-3 rounded-xl">
                        <div class="flex items-center space-x-2">
                            ...
                            <div>
                                ...
                                <p class="text-xl font-bold text-white">$<?php echo e(number_format($totalRevenue / 100, 2)); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="stat-card rounded-2xl p-6 border-l-4 border-green-500 animate-slide-in-right" style="animation-delay: 0.1s;">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-4xl font-black text-green-400 mt-2"><?php echo e($activeCount); ?></p>
            ...
            <div class="stat-card rounded-2xl p-6 border-l-4 border-yellow-500 animate-slide-in-right" style="animation-delay: 0.2s;">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-4xl font-black text-yellow-400 mt-2"><?php echo e($subscriptions->where('status', 'pending')->count()); ?></p>
            ...
            <div class="stat-card rounded-2xl p-6 border-l-4 border-orange-500 animate-slide-in-right" style="animation-delay: 0.3s;">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-4xl font-black text-orange-400 mt-2"><?php echo e($expiringSoonCount); ?></p>
            ...
            <div class="stat-card rounded-2xl p-6 border-l-4 border-red-500 animate-slide-in-right" style="animation-delay: 0.4s;">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-4xl font-black text-red-400 mt-2"><?php echo e($cancelledCount); ?></p>
        ...
        <div class="gradient-border rounded-2xl animate-fade-in-up" style="animation-delay: 0.5s;">
            <div class="glass-morphism rounded-2xl p-6">
                ...
                <form method="GET" action="<?php echo e(route('superadmin.subscriptions.index')); ?>" class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <!-- Search -->
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $subscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $subscription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="subscription-row" style="animation: fadeInUp 0.5s ease-out <?php echo e(($index * 0.05)); ?>s forwards; opacity: 0;">
                                <td class="px-6 py-5 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            <div class="text-sm font-bold text-white"><?php echo e($subscription->school->name); ?></div>
                                            <div class="text-sm text-gray-400"><?php echo e($subscription->school->slug); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-5 whitespace-nowrap">
                                    <div class="text-sm font-semibold text-white"><?php echo e($subscription->plan->name); ?></div>
                                    <div class="text-xs text-gray-400"><?php echo e($subscription->plan->storage_limit_in_gb); ?> GB</div>
                                </td>
                                <td class="px-6 py-5 whitespace-nowrap">
                                    <?php if(isset($subscription->status)): ?>
                                        ...
                                        <?php else: ?>
                                            <span class="text-sm text-gray-400"><?php echo e(ucfirst($subscription->status)); ?></span>
                                        <?php endif; ?>
                                    <?php else: ?>
                                ...
                                <td class="px-6 py-5 whitespace-nowrap">
                                    <div class="space-y-1">
                                        <?php if($subscription->starts_at): ?>
                                            <div class="text-sm text-gray-300"><?php echo e($subscription->starts_at->format('M d, Y')); ?></div>
                                        <?php endif; ?>
                                        <?php if($subscription->ends_at): ?>
                                            <div class="text-sm text-gray-300"><?php echo e($subscription->ends_at->format('M d, Y')); ?></div>
                                            <?php if($subscription->ends_at->isPast()): ?>
                                                <span class="text-xs text-red-400">Expired</span>
                                            <?php elseif($subscription->ends_at->diffInDays() <= 30): ?>
                                                <span class="text-xs text-yellow-400"><?php echo e($subscription->ends_at->diffInDays()); ?> days left</span>
                                            <?php endif; ?>
                                        <?php else: ?>
                                ...
                                <td class="px-6 py-5 whitespace-nowrap">
                                    <div class="text-base font-bold text-white">$<?php echo e(number_format($subscription->plan->price_monthly / 100, 2)); ?></div>
                                    <div class="text-xs text-gray-400">per month</div>
                                </td>
                                <td class="px-6 py-5 whitespace-nowrap">
                                    <div class="flex items-center space-x-2">
                                        <a href="<?php echo e(route('superadmin.subscriptions.edit', $subscription)); ?>" class="action-button p-2 bg-indigo-600/20 hover:bg-indigo-600/30 rounded-lg" title="Edit">
                                        ...
                                        <?php if(isset($subscription->status)): ?>
                                            <?php if($subscription->status === 'pending'): ?>
                                                <form method="POST" action="<?php echo e(route('superadmin.subscriptions.activate', $subscription)); ?>" class="inline">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('PATCH'); ?>
                                                    <button type="submit" class="action-button p-2 bg-green-600/20 hover:bg-green-600/30 rounded-lg" onclick="return confirm('Activate subscription for <?php echo e($subscription->school->name); ?>?')" title="Activate">
                                            ...
                                            <?php elseif($subscription->status === 'active'): ?>
                                                <form method="POST" action="<?php echo e(route('superadmin.subscriptions.pause', $subscription)); ?>" class="inline">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('PATCH'); ?>
                                            ...
                                            <?php elseif($subscription->status === 'paused'): ?>
                                                <form method="POST" action="<?php echo e(route('superadmin.subscriptions.resume', $subscription)); ?>" class="inline">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('PATCH'); ?>
                                            ...
                                            <?php endif; ?>
                                        <?php endif; ?>
                                        <a href="<?php echo e(route('superadmin.schools.edit', $subscription->school)); ?>" class="action-button p-2 bg-purple-600/20 hover:bg-purple-600/30 rounded-lg" title="View School">
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-16 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <div class="flex items-center space-x-4">
                                            <a href="<?php echo e(route('superadmin.subscriptions.index')); ?>" class="px-6 py-3 bg-gray-700 hover:bg-gray-600 text-white font-semibold rounded-xl">Clear Filters</a>
                                            <a href="<?php echo e(route('superadmin.schools.create')); ?>" class="px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-xl">Create School</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
            ...
            <div class="glass-morphism rounded-2xl p-6 animate-fade-in-up" style="animation-delay: 0.7s;">
                <div class="flex items-center justify-between">
                    <div class="text-sm text-gray-400">
                        Showing <span class="font-semibold text-white"><?php echo e($subscriptions->firstItem()); ?></span>
                        to <span class="font-semibold text-white"><?php echo e($subscriptions->lastItem()); ?></span>
                        of <span class="font-semibold text-white"><?php echo e($subscriptions->total()); ?></span> subscriptions
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-white mt-1">
                            $<?php echo e($activeCount > 0 ? number_format($totalRevenue / $activeCount / 100, 2) : '0.00'); ?>
            ...
            <div class="glass-morphism rounded-xl p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-white mt-1">
                            <?php echo e($totalCount > 0 ? number_format(($activeCount / $totalCount) * 100, 1) : '0'); ?>%
                        </p>
                    </div>
            ...
            <div class="glass-morphism rounded-xl p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-white mt-1">
                            <?php echo e($totalCount > 0 ? number_format(($cancelledCount / $totalCount) * 100, 1) : '0'); ?>%
                        </p>
                    </div>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        let hasPendingSubscriptions = <?php echo e($subscriptions->where('status', 'pending')->count() > 0 ? 'true' : 'false'); ?>;
...
<?php echo $__env->make('layouts.superadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eXtreme\Documents\custom\resources\views\superadmin\subscriptions\index.blade.php ENDPATH**/ ?>