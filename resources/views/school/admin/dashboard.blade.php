            ...
            <div class="px-8 py-6 border-b border-gray-100">
                <div class="flex items-center justify-between flex-wrap gap-4">
                    ...
                    <div class="flex items-center gap-3 no-print">
                        ...
                        <a href="{{ route('school.admin.file-browser.index', $school->slug) }}?role=teacher"
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-8 py-6 no-print">
                                <div class="flex items-center justify-center space-x-2">
                                    ...
                                    @if($canPreview)
                                        <button onclick="printFile('{{ route('school.admin.file-browser.preview', [$school->slug, $file->id]) }}', '{{ $file->title }}', '{{ $file->user->name ?? __('messages.users.unknown') }}', '{{ $file->created_at->format('M d, Y') }}')"
            ...
            <div class="px-8 py-6 border-b border-gray-100">
                <div class="flex items-center justify-between flex-wrap gap-4">
                    ...
                    <div class="flex items-center gap-3 no-print">
                        ...
                        <a href="{{ route('school.admin.file-browser.index', $school->slug) }}?role=supervisor"
