<?php $__env->startSection('page-title', 'School Activity Logs - ' . $school->name); ?>
    ...
    <div class="space-y-8">
            ...
            <div class="glass-morphism rounded-2xl p-8">
                <div class="relative flex items-center justify-between">
                        ...
                        <div>
                            ...
                            <?php if($school->address): ?>
                                <p class="mt-1 text-sm text-gray-400 flex items-center space-x-2">
                                    ...
                                    <span><?php echo e($school->address); ?></span>
                                </p>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="flex items-center space-x-3">
                        ...
                        <a href="<?php echo e(route('superadmin.activity-logs.export', array_merge(request()->all(), ['school_id' => $school->id]))); ?>"
                                ...
                                <div class="user-rank-badge group bg-gradient-to-br from-gray-800/80 to-gray-900/80 rounded-xl p-5 border border-gray-700/50 hover:border-indigo-500/50 relative overflow-hidden">
                                    ...
                                    <?php if($index < 3): ?>
                                        <div class="absolute top-2 right-2 h-8 w-8 rounded-full flex items-center justify-center font-bold text-sm shadow-lg
                                            <?php echo e($index === 0 ? 'bg-gradient-to-br from-yellow-400 to-yellow-600 text-yellow-900' : ''); ?>

                                            <?php echo e($index === 1 ? 'bg-gradient-to-br from-gray-300 to-gray-500 text-gray-900' : ''); ?>

                                            <?php echo e($index === 2 ? 'bg-gradient-to-br from-orange-400 to-orange-600 text-orange-900' : ''); ?>">
                                            #<?php echo e($index + 1); ?>
                                    ...
                                    <div class="flex flex-col items-center text-center space-y-3">
                                        ...
                                        <div class="w-full">
                                            <p class="text-sm font-bold text-white truncate"><?php echo e($activeUser['user']->name); ?></p>
                                            <p class="text-xs text-indigo-400 font-semibold mt-1"><?php echo e($activeUser['user']->role); ?></p>
                                            <div class="mt-3 inline-flex items-center px-3 py-1.5 bg-gradient-to-r from-indigo-900/50 to-purple-900/50 rounded-full ring-1 ring-indigo-500/30">
                                                ...
                                                <span class="text-xs font-bold text-white"><?php echo e($activeUser['activity_count']); ?></span>
        ...
        <div class="gradient-border animate-fade-in-up" style="animation-delay: 0.6s;">
            <div class="glass-morphism rounded-2xl p-8">
                ...
                <form method="GET" action="<?php echo e(route('superadmin.activity-logs.school', $school)); ?>" class="grid grid-cols-1 md:grid-cols-5 gap-6">
                    <div>
                    ...
                    <div class="md:col-span-2 flex items-end space-x-3">
                        ...
                        <a href="<?php echo e(route('superadmin.activity-logs.school', $school)); ?>" class="px-6 py-3 bg-gray-700/50 hover:bg-gray-600/50 text-white font-semibold rounded-xl transition-all duration-300 flex items-center space-x-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="glass-morphism rounded-2xl p-8">
                <div class="flex items-center justify-between mb-8">
                    ...
                    <span class="px-3 py-1 bg-indigo-900/30 text-indigo-400 text-sm font-semibold rounded-full">
                        <?php echo e($activities->total()); ?> Activities
                    </span>
                </div>
                            ...
                            <div class="bg-gray-800/40 rounded-xl p-5 hover:bg-gray-800/60 transition-all duration-300">
                                <div class="flex items-start justify-between">
                                    <div class="flex-1 space-y-3">
                                        ...
                                        <div class="flex flex-wrap items-center gap-2">
                                            <?php if($activity->causer): ?>
                                                ...
                                                <span class="px-2 py-1 bg-indigo-900/30 text-indigo-300 text-xs font-medium rounded-lg">
                                                    <?php echo e($activity->causer->role); ?>
                                            ...
                                            <?php if($activity->event): ?>
                                                <span class="inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-bold <?php echo e($activity->event === 'created' ? 'bg-green-900/50 text-green-300 ring-1 ring-green-500/50' :
                                        ...
                                        <!-- Description -->
                                        <p class="text-sm text-gray-200 leading-relaxed font-medium"><?php echo e($activity->description); ?></p>
                                        ...
                                        <div class="flex flex-wrap items-center gap-4 text-xs">
                                            <span class="flex items-center space-x-1 text-gray-400">
                                                ...
                                                <span class="font-semibold text-white"><?php echo e($activity->created_at->format('M d, Y • H:i:s')); ?></span>
                                            ...
                                            <?php if(!empty($activity->properties['ip_address'])): ?>
                                                <span class="flex items-center space-x-1 px-2 py-1 bg-gray-700/30 rounded-lg">
                                                    ...
                                                    <span class="font-mono text-gray-300"><?php echo e($activity->properties['ip_address']); ?></span>
                                                </span>
                                            <?php endif; ?>
                                        </div>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="text-center py-20">
                            ...
                            <p class="text-gray-400 max-w-md mx-auto mb-6">
                                No activities have been recorded for <span class="text-indigo-400 font-semibold"><?php echo e($school->name); ?></span> matching your filters.
                            </p>
                            <a href="<?php echo e(route('superadmin.activity-logs.school', $school)); ?>"
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            let lastActivityCount = <?php echo e($stats['today']); ?>;
            ...
            document.addEventListener('keydown', function(e) {
                ...
                if ((e.ctrlKey || e.metaKey) && e.key === 'e') {
                    e.preventDefault();
                    window.location.href = "<?php echo e(route('superadmin.activity-logs.export', array_merge(request()->all(), ['school_id' => $school->id]))); ?>";
                }
            });
...
<?php echo $__env->make('layouts.superadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eXtreme\Documents\custom\resources\views\superadmin\activity-logs\school.blade.php ENDPATH**/ ?>