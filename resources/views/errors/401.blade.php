...
<head>
    ...
    <title>{{ __('messages.errors.400.title', [], 'Bad Request') }} - {{ __('messages.app.name') }}</title>
...
<div class="text-center max-w-2xl mx-auto">
    ...
    <h1 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4">{{ __('messages.errors.400.heading', [], 'Bad Request') }}</h1>
    <p class="text-lg text-gray-600 mb-8 max-w-md mx-auto">{{ __('messages.errors.400.message', [], 'The request could not be understood by the server due to malformed syntax.') }}</p>
