    ...
    <div id="iosInstallModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
        <div class="bg-white rounded-2xl p-6 max-w-md w-full">
            ...
            <ol class="list-decimal list-inside space-y-2 mt-4 text-gray-700">
                <li>Tap the Share button <i class="ri-share-box-line"></i> at the bottom</li>
                <li>Scroll down and tap "Add to Home Screen"</li>
                <li>Tap "Add" to install</span>
            </ol>
...
<?php /**PATH C:\Users\eXtreme\Documents\custom\resources\views\components\pwa-install-button.blade.php ENDPATH**/ ?>