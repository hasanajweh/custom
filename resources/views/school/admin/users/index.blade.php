    ...
    <div class="min-h-screen bg-gray-50 py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                <div class="flex items-center justify-between flex-wrap gap-4">
                    ...
                    <div class="flex gap-3">
                        <a href="{{ safe_tenant_route('school.admin.users.archived', $school) }}"
                        ...
                        <a href="{{ safe_tenant_route('school.admin.users.create', $school) }}"
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                <form method="GET" action="{{ safe_tenant_route('school.admin.users.index', $school) }}">
                    <div class="mb-4">
                        <div class="relative">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-8 py-6">
                                    <div class="flex items-center justify-center {{ app()->getLocale() === 'ar' ? 'space-x-reverse' : '' }} space-x-2">
                                        <a href="{{ safe_tenant_route('school.admin.users.edit', $school, ['user' => $user->id]) }}"
                                        ...
                                        @if($user->id !== Auth::id())
                                            <form method="POST"
                                                  action="{{ safe_tenant_route('school.admin.users.toggle-status', $school, ['user' => $user->id]) }}"
                                                  class="inline">
                                                @csrf
                                                @method('PATCH')
                                                <button type="submit"
                                            ...
                                            <form method="POST"
                                                  action="{{ safe_tenant_route('school.admin.users.destroy', $school, ['user' => $user->id]) }}"
