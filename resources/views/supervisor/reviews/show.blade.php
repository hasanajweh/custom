...
@section('content')
    <div class="max-w-4xl mx-auto space-y-6">
        <!-- Back Button -->
        <a href="{{ route('supervisor.reviews.index', ['school' => $school->slug]) }}"
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="border-t border-gray-200 pt-6">
                    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                        <a href="{{ route('supervisor.reviews.download', ['school' => $school->slug, 'fileSubmission' => $fileSubmission->id]) }}"
                        ...
                        <a href="{{ route('supervisor.reviews.preview', ['school' => $school->slug, 'fileSubmission' => $fileSubmission->id]) }}"
                           target="_blank"
