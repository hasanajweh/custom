...
<head>
    ...
    <title><?php echo e(__('messages.errors.404.title')); ?> - <?php echo e(__('messages.app.name')); ?></title>
...
<div class="text-center max-w-2xl mx-auto">
    ...
    <div class="relative mb-8">
        ...
        <div class="absolute inset-0 flex items-center justify-center">
            <img src="/WayUp.png" alt="<?php echo e(__('messages.app.name')); ?>" class="w-24 h-24 md:w-32 md:h-32 opacity-20 float-animation">
        </div>
    </div>

    <!-- Message -->
    <h1 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
        <?php echo e(__('messages.errors.404.heading')); ?>

    </h1>
    <p class="text-lg text-gray-600 mb-8 max-w-md mx-auto">
        <?php echo e(__('messages.errors.404.message')); ?>
...
<?php /**PATH C:\Users\eXtreme\Documents\custom\resources\views\errors\404.blade.php ENDPATH**/ ?>