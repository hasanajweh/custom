...
@section('content')
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <form method="GET" action="{{ route('school.admin.users.archived', $school->slug) }}">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors opacity-75">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center space-x-2">
                                    <!-- Restore Button -->
                                    <form method="POST"
                                          action="{{ route('school.admin.users.restore', [$school->slug, $user->id]) }}"
                                    ...
                                    <form method="POST"
                                          action="{{ route('school.admin.users.force-delete', [$school->slug, $user->id]) }}"
